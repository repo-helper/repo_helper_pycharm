...
documentation_summary = "repo_helper extension to manage PyCharm's configuration."
...
rst_prolog = f""".. |pkgname| replace:: repo_helper_pycharm
.. |pkgname2| replace:: ``repo_helper_pycharm``
