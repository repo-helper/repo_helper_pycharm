...
from domdf_python_tools.testing import check_file_output, check_file_regression, not_pypy
...
class BaseTest:
	...
	def make_fake_iml(self, tmp_pathplus):
...
class TestCommand(BaseTest):
	...
	def test_iml_manager_not_project(self, no_idea, tmp_pathplus, file_regression: FileRegressionFixture, tmp_project):
...
class TestClass(BaseTest):
	...
	@pytest.mark.usefixtures("tmp_project")
	def test_iml_manager_not_project(self, tmp_pathplus, no_idea):
